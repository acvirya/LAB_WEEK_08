...
class SecondNotificationService: Service() {
    ...
    //Create a system handler which controls what thread the process is
//    being executed on
...
//Return the channel id
    ...
    private fun getNotificationBuilder(
        ...
        NotificationCompat.Builder(this, channelId)
            ...
            .setTicker("Third worker process is done, almost there!")
            .setOngoing(true)
...
//Here we're notifying the MainActivity that the service
//            process is done
